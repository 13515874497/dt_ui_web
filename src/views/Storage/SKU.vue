<template>
  <div id="packBox">
    ...
    <h1 class="translation">GLOBEGOU WZ CO.,LTD</h1>
    <h3
      class="address"
    >RM 209, BUILDING A, LANJIANG SOFTWARE PARK, LANJIANG ROAD, WENZHOU, ZHEJIANG, CHINA</h3>
    ...
    >
      <el-table-column prop="NOS." label="NOS."></el-table-column>
      <el-table-column prop="SPECIFICATION" label="SPECIFICATION"></el-table-column>
      <el-table-column prop="CARTON" label="CARTON"></el-table-column>
      <el-table-column prop="QUANTITY" label="QUANTITY"></el-table-column>
      <el-table-column prop="GR_WT" label="GR.WT."></el-table-column>
      <el-table-column prop="NET_WT" label="NET.WT"></el-table-column>
      <el-table-column prop="MEAS" label="MEAS."></el-table-column>
    </el-table>

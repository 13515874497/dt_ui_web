<template>
    <div id="invoiceBox">
        ...
        <h1 class="titleTop">COMMERCIAL INVOICE</h1>
...
.invoiceRight .invoiceNum {
  line-height: 40px;
}
.invoiceNum .invoiceNumspan {
  width: 20%;
  /* padding-left: 25px; */
  display: inline-block;
}
.invoiceNum .invoiceNuminput {
  width: 70%;
  outline: none;
  border: none;
}

  ...
  <div class="div-two">
    <div class="register-box">
      <div style="width: 390px;margin: 0 auto;">
        ...
        <el-input class="input register_input" type="password" placeholder="请输入密码" v-focus
                  prefix-icon="iconfont icon_dt-suo" v-model="form.pwd">
        </el-input>

        <p class="register_pwd">确认密码</p>
        <el-input class="input register_input" type="password" placeholder="请确认密码" v-focus

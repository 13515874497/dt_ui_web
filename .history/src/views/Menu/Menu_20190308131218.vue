        ...
        <el-tab-pane v-if="data.url" label="字段信息" name="second">
          ...
          >
            <span class="custom-tree-node" slot-scope="{ node, data }">
              ...
              <span>
                <el-button type="text" size="mini" @click="() => editField(data)"> <i class="el-icon-edit"></i></el-button>
                <el-button type="text" size="mini" @click="() => removeField(data)"> <i class="el-icon-delete"></i></el-button>
              </span>
            </span>
          </el-tree>
